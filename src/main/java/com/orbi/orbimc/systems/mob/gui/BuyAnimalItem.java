...
public class BuyAnimalItem implements Inventory {
    ...
    public void initializeInventory() {
        InventoryBuilder2 inventory = new InventoryBuilder2(Pattern.FILL, 54, "buy-animal-item-title");
        inventory.setItem(1, new ItemBuilder(Material.DIAMOND_SWORD));
        inventory.setItem(3, new ItemBuilder(Material.EGG, true));
